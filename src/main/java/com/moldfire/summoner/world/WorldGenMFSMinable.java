...
public class WorldGenMFSMinable extends WorldGenerator
{
    ...
    public WorldGenMFSMinable(IBlockState state, int blockCount)
    {
    	this(state, blockCount, BlockHelper.forBlock(Blocks.stone));
    }

    public WorldGenMFSMinable(IBlockState state, int blockCount, BlockHelper forBlock)
    {
    	this.oreBlock = state;
        this.numberOfBlocks = blockCount;
        this.predicate = forBlock;
	}
	                        ...
	                        if (d12 * d12 + d13 * d13 < 1.0D)
	                        {
	                            for (int j2 = l; j2 <= k1; ++j2)
	                            {
	                                ...
	                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D)
	                                {
	                                    ...
	                                    {
	                                    	System.out.println("[MFS] - Generating Ore ["+blockpos+"]");
